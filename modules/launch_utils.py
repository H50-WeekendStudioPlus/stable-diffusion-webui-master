...
def prepare_environment():
    ...
    stable_diffusion_repo = os.environ.get('STABLE_DIFFUSION_REPO', "https://gh.llkk.cc/https://github.com/nlile/stablediffusion.git")
    stable_diffusion_xl_repo = os.environ.get('STABLE_DIFFUSION_XL_REPO', "https://gh.llkk.cc/https://github.com/Stability-AI/generative-models.git")
    k_diffusion_repo = os.environ.get('K_DIFFUSION_REPO', 'https://github.com/crowsonkb/k-diffusion.git')
    blip_repo = os.environ.get('BLIP_REPO', 'https://gh.llkk.cc/https://github.com/salesforce/BLIP.git')
